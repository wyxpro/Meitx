...
| Endpoint | `POST https://app-crzi248am2gx-api-eLMlJ2jB44g9-gateway.appmiaoda.com/rest/2.0/ocr/v1/accurate_basic` |
| 认证模式 | `platform_managed` |
| Auth Header | `X-Gateway-Authorization: Bearer ${INTEGRATIONS_API_KEY}` |
| Content-Type | `application/x-www-form-urlencoded` |
| third_part_domain | `app-crzi248am2gx-api-eLMlJ2jB44g9-gateway.appmiaoda.com` |
| 流式响应 | 否 |
...
async function callOcrAccurateBasic(
  ...
  const response = await fetch(
    "https://app-crzi248am2gx-api-eLMlJ2jB44g9-gateway.appmiaoda.com/rest/2.0/ocr/v1/accurate_basic",
    {
      method: "POST",
      headers: {
        "Content-Type": "application/x-www-form-urlencoded",
