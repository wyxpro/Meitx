...
| Endpoint | `POST https://app-crzi248am2gx-api-DLEO7Vjd8Qea-gateway.appmiaoda.com/rest/2.0/ocr/v1/air_ticket` |
| Auth 模式 | `platform_managed` |
| Auth Header | `X-Gateway-Authorization: Bearer ${INTEGRATIONS_API_KEY}` |
| Content-Type | `application/x-www-form-urlencoded` |
| Third-party Domain | `app-crzi248am2gx-api-DLEO7Vjd8Qea-gateway.appmiaoda.com` |
...
async function recognizeAirTicket(options: {
  ...
  const response = await fetch(
    "https://app-crzi248am2gx-api-DLEO7Vjd8Qea-gateway.appmiaoda.com/rest/2.0/ocr/v1/air_ticket",
    {
      method: "POST",
      headers: {
        "Content-Type": "application/x-www-form-urlencoded",
