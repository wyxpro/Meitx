...
| Endpoint | `GET https://app-crzi248am2gx-api-wLNdo2j5eQWa-gateway.appmiaoda.com/v2/baike/lemma/get_content` |
| 认证模式 | `platform_managed` |
| Auth Header | `X-Gateway-Authorization: Bearer ${INTEGRATIONS_API_KEY}` |
| Accept | `application/json` |
| third_part_domain | `app-crzi248am2gx-api-wLNdo2j5eQWa-gateway.appmiaoda.com` |
...
async function getBaikeLemma(
  ...
  const response = await fetch(
    `https://app-crzi248am2gx-api-wLNdo2j5eQWa-gateway.appmiaoda.com/v2/baike/lemma/get_content?${params}`,
    {
      method: "GET",
      headers: {
        "Accept": "application/json",
