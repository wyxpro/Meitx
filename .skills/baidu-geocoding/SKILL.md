...
|------|------|----------|--------|
| 地理编码 | 地址 → 坐标 | `GET https://app-crzi248am2gx-api-GaDwZ0j3erOY-gateway.appmiaoda.com/geocoding/v3/` | GET |
| 逆地理编码 | 坐标 → 地址 | `GET https://app-crzi248am2gx-api-baBwZEjbe1X9-gateway.appmiaoda.com/reverse_geocoding/v3` | GET |
...
const response = await fetch(
  `https://app-crzi248am2gx-api-GaDwZ0j3erOY-gateway.appmiaoda.com/geocoding/v3/?${params}`,
  {
    method: "GET",
    headers: {
