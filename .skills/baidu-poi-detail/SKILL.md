...
| 接口 | 作用 | Endpoint |
|------|------|----------|
| **行政区划区域检索** | 在指定行政区划（省/市/区县）内按关键词检索 POI | `GET https://app-crzi248am2gx-api-ra5EZvmRrG4a-gateway.appmiaoda.com/place/v3/region` |
| **圆形区域检索** | 以经纬度为圆心、指定半径范围内检索周边 POI | `GET https://app-crzi248am2gx-api-DLEO7eMnzMwa-gateway.appmiaoda.com/place/v3/around` |
| **地点详情检索** | 根据 POI uid 获取详细信息（评分/营业时间/价格等） | `GET https://app-crzi248am2gx-api-GaDwZekp8WzY-gateway.appmiaoda.com/place/v3/detail` |
