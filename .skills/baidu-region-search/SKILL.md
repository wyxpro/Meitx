...
| 属性 | 值 |
|------|---|
| Endpoint | `GET https://app-crzi248am2gx-api-DYJwn2VZXvEa-gateway.appmiaoda.com/api_region_search/v1/` |
...
async function queryAdminRegion(
  ...
  const response = await fetch(
    `https://app-crzi248am2gx-api-DYJwn2VZXvEa-gateway.appmiaoda.com/api_region_search/v1/?${params.toString()}`,
    {
      method: "GET",
      headers: {
