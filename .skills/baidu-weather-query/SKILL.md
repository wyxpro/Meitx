...
| 接口 | 方法 | Endpoint | 核心功能 |
|------|------|----------|----------|
| 国内天气查询 | GET | `https://app-crzi248am2gx-api-oLpZbd8ed8wa-gateway.appmiaoda.com/weather/v1/` | 按行政区划代码查询实时天气 + 未来7天预报 |
| 国内经纬度天气查询 | GET | `https://app-crzi248am2gx-api-GYX1bnRz2Pxa-gateway.appmiaoda.com/weather/v1/` | 按经纬度查询实时天气 + 未来7天预报 + 24小时逐小时预报 |
...
async function getWeatherByDistrict(districtId: string, dataType = "all"): Promise<unknown> {
  const url = new URL("https://app-crzi248am2gx-api-oLpZbd8ed8wa-gateway.appmiaoda.com/weather/v1/");
