...
| Endpoint | `POST https://app-crzi248am2gx-api-Xa6JZxjyqrGa-gateway.appmiaoda.com/rest/2.0/ocr/v1/bus_ticket` |
| Auth 模式 | platform_managed |
| Auth Header | `X-Gateway-Authorization: Bearer <INTEGRATIONS_API_KEY>` |
| Content-Type | `application/x-www-form-urlencoded` |
| third_part_domain | `app-crzi248am2gx-api-Xa6JZxjyqrGa-gateway.appmiaoda.com` |
...
async function recognizeBusTicket(params: {
  ...
  const response = await fetch(
    "https://app-crzi248am2gx-api-Xa6JZxjyqrGa-gateway.appmiaoda.com/rest/2.0/ocr/v1/bus_ticket",
    {
      method: "POST",
      headers: {
        "Content-Type": "application/x-www-form-urlencoded",
