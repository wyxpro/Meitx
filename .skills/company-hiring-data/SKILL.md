...
| 接口 | Endpoint | 返回内容 |
|------|----------|---------|
| 招聘概况查询 | `POST https://app-crzi248am2gx-api-Aa2PZ2MejdoL-gateway.appmiaoda.com/enterprise/hire-overview` | 职位关键词、职位类型、城市分布、招聘来源、职位级别、平均薪资、职位数量等概况 |
| 招聘数据统计 | `POST https://app-crzi248am2gx-api-zYkZzErqJg4L-gateway.appmiaoda.com/enterprise/hire-statistics` | 平均薪资、学历分布、主要省份、招聘职位、薪资区间、工作年限分布、招聘数量时间序列等详细统计 |
