...
| Endpoint（创建会话） | `POST https://app-crzi248am2gx-api-ELbWqrZ1krJY-gateway.appmiaoda.com/v2/agent/deepresearch/create` |
| Endpoint（发起研究） | `POST https://app-crzi248am2gx-api-ELbWqrZ1krJY-gateway.appmiaoda.com/v2/agent/deepresearch/run` |
| 认证模式             | platform_managed                                             |
| Auth Header          | `X-Gateway-Authorization: Bearer <INTEGRATIONS_API_KEY>`     |
| Content-Type         | `application/json`                                           |
| 响应类型             | SSE 流式（text/event-stream）                                |
| third_part_domain    | `app-crzi248am2gx-api-ELbWqrZ1krJY-gateway.appmiaoda.com`                                       |
...
**接口地址**: `POST https://app-crzi248am2gx-api-ELbWqrZ1krJY-gateway.appmiaoda.com/v2/agent/deepresearch/create`
...
```bash
curl -X POST "https://app-crzi248am2gx-api-ELbWqrZ1krJY-gateway.appmiaoda.com/v2/agent/deepresearch/create?agent_id=xxx" \
...
**接口地址**: `POST https://app-crzi248am2gx-api-ELbWqrZ1krJY-gateway.appmiaoda.com/v2/agent/deepresearch/run`
