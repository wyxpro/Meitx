...
| 维度 | 说明 |
|------|------|
| 提交接口 | `POST https://app-crzi248am2gx-api-rY7JZ6jqrneL-gateway.appmiaoda.com/rest/2.0/ocr/v1/doc_convert/request` |
| 查询接口 | `POST https://app-crzi248am2gx-api-oYA6ZGjReooa-gateway.appmiaoda.com/rest/2.0/ocr/v1/doc_convert/get_request_result` |
...
async function submitDocConvert(
  ...
  const response = await fetch(
    "https://app-crzi248am2gx-api-rY7JZ6jqrneL-gateway.appmiaoda.com/rest/2.0/ocr/v1/doc_convert/request",
    {
      method: "POST",
      headers: {
        "Content-Type": "application/x-www-form-urlencoded",
...
async function queryDocConvert(taskId: string): Promise<{
  ...
  const response = await fetch(
    "https://app-crzi248am2gx-api-oYA6ZGjReooa-gateway.appmiaoda.com/rest/2.0/ocr/v1/doc_convert/get_request_result",
    {
      method: "POST",
      headers: {
        "Content-Type": "application/x-www-form-urlencoded",
