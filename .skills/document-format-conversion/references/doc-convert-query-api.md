...
| Endpoint | `POST https://app-crzi248am2gx-api-oYA6ZGjReooa-gateway.appmiaoda.com/rest/2.0/ocr/v1/doc_convert/get_request_result` |
| Content-Type | `application/x-www-form-urlencoded` |
| Auth 模式 | `platform_managed`（`traefik: true`） |
| Auth Header | `X-Gateway-Authorization: Bearer ${INTEGRATIONS_API_KEY}` |
| third_part_domain | `app-crzi248am2gx-api-oYA6ZGjReooa-gateway.appmiaoda.com` |
| 计费 | **不计费**，按需轮询 |
