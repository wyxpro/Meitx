...
- **Endpoint**: `POST https://app-crzi248am2gx-api-o9wN0mk1DAPa-gateway.appmiaoda.com/driverexam/query`
...
async function queryDrivingExamQuestions(
  ...
  const response = await fetch(
    `https://app-crzi248am2gx-api-o9wN0mk1DAPa-gateway.appmiaoda.com/driverexam/query?${params.toString()}`,
    {
      method: "POST",
      headers: {
