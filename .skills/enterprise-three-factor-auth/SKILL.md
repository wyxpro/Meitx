...
- **Endpoint**: `GET https://app-crzi248am2gx-api-Aa2PZnjE80BL-gateway.appmiaoda.com/company_three/get`
...
async function verifyCompanyThreeFactors(
  ...
  const response = await fetch(
    `https://app-crzi248am2gx-api-Aa2PZnjE80BL-gateway.appmiaoda.com/company_three/get?${params.toString()}`,
    {
      method: "GET",
      headers: {
        "Content-Type": "application/json;charset=UTF-8",
...
- **third_part_domain**: `app-crzi248am2gx-api-Aa2PZnjE80BL-gateway.appmiaoda.com`
