...
| Endpoint | `POST https://app-crzi248am2gx-api-e94GZ5j0PwVa-gateway.appmiaoda.com/rest/2.0/face/v3/search` |
| Auth 模式 | `platform_managed` |
| Auth Header | `X-Gateway-Authorization: Bearer <INTEGRATIONS_API_KEY>` |
| Content-Type | `application/json` |
| third_part_domain | `app-crzi248am2gx-api-e94GZ5j0PwVa-gateway.appmiaoda.com` |
...
async function searchFace(
  ...
  const response = await fetch(
    "https://app-crzi248am2gx-api-e94GZ5j0PwVa-gateway.appmiaoda.com/rest/2.0/face/v3/search",
    {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
