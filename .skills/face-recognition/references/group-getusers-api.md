...
| Endpoint | `POST https://app-crzi248am2gx-api-baBwZEjb7P19-gateway.appmiaoda.com/rest/2.0/face/v3/faceset/group/getusers` |
| Auth 模式 | `platform_managed` |
| Auth Header | `X-Gateway-Authorization: Bearer <INTEGRATIONS_API_KEY>` |
| Content-Type | `application/json` |
| third_part_domain | `app-crzi248am2gx-api-baBwZEjb7P19-gateway.appmiaoda.com` |
| 计费 | 否 |
...
async function getGroupUsers(start = 0, length = 100): Promise<{ user_id_list: string[] }> {
  const response = await fetch(
    "https://app-crzi248am2gx-api-baBwZEjb7P19-gateway.appmiaoda.com/rest/2.0/face/v3/faceset/group/getusers",
    {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
