...
| Endpoint | `POST https://app-crzi248am2gx-api-l9nZz8ro7Bl9-gateway.appmiaoda.com/rest/2.0/face/v3/faceset/user/add` |
| Auth 模式 | `platform_managed` |
| Auth Header | `X-Gateway-Authorization: Bearer <INTEGRATIONS_API_KEY>` |
| Content-Type | `application/json` |
| third_part_domain | `app-crzi248am2gx-api-l9nZz8ro7Bl9-gateway.appmiaoda.com` |
...
async function registerFace(
  ...
  const response = await fetch(
    "https://app-crzi248am2gx-api-l9nZz8ro7Bl9-gateway.appmiaoda.com/rest/2.0/face/v3/faceset/user/add",
    {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
