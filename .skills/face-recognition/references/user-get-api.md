...
| Endpoint | `POST https://app-crzi248am2gx-api-GaDwZ0j38X6Y-gateway.appmiaoda.com/rest/2.0/face/v3/faceset/user/get` |
| Auth 模式 | `platform_managed` |
| Auth Header | `X-Gateway-Authorization: Bearer <INTEGRATIONS_API_KEY>` |
| Content-Type | `application/json` |
| third_part_domain | `app-crzi248am2gx-api-GaDwZ0j38X6Y-gateway.appmiaoda.com` |
| 计费 | 否 |
...
async function getFaceUser(userId: string): Promise<{
  ...
  const response = await fetch(
    "https://app-crzi248am2gx-api-GaDwZ0j38X6Y-gateway.appmiaoda.com/rest/2.0/face/v3/faceset/user/get",
    {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
