...
| Endpoint | `POST https://app-crzi248am2gx-api-o9wN0AExZQ8a-gateway.appmiaoda.com/v1beta/models/gemini-3.1-flash-image-preview:generateContent` |
| Content-Type | `application/json` |
| 认证模式 | `platform_managed` |
| Auth Header | `X-Gateway-Authorization: Bearer ${INTEGRATIONS_API_KEY}` |
| 第三方域名 | `app-crzi248am2gx-api-o9wN0AExZQ8a-gateway.appmiaoda.com` |
| 流式响应 | 否 |
| 计费 | 按调用次数计费，原价 `0.00` |
...
async function callGeminiImageEdit(
  ...
  const response = await fetch(
    "https://app-crzi248am2gx-api-o9wN0AExZQ8a-gateway.appmiaoda.com/v1beta/models/gemini-3.1-flash-image-preview:generateContent",
    {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
