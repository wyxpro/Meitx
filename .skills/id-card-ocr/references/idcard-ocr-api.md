...
| Endpoint | `POST https://app-crzi248am2gx-api-k93RZBjP0zqa-gateway.appmiaoda.com/rest/2.0/ocr/v1/idcard` |
| Content-Type | `application/x-www-form-urlencoded` |
| Auth Header | `X-Gateway-Authorization: Bearer ${INTEGRATIONS_API_KEY}` |
| 认证模式 | `platform_managed` |
| third_part_domain | `app-crzi248am2gx-api-k93RZBjP0zqa-gateway.appmiaoda.com` |
...
async function recognizeIdCard(
  ...
  const response = await fetch(
    "https://app-crzi248am2gx-api-k93RZBjP0zqa-gateway.appmiaoda.com/rest/2.0/ocr/v1/idcard",
    {
      method: "POST",
      headers: {
        "Content-Type": "application/x-www-form-urlencoded",
...
- **第三方域名**：实际请求转发至 `app-crzi248am2gx-api-k93RZBjP0zqa-gateway.appmiaoda.com`，网关代理后客户端无需感知。
