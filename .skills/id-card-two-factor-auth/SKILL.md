...
- **Endpoint**：`GET https://app-crzi248am2gx-api-oLpZ74noWOMa-gateway.appmiaoda.com/idcard`
...
async function verifyIdCardTwoFactor(
  ...
  const response = await fetch(
    `https://app-crzi248am2gx-api-oLpZ74noWOMa-gateway.appmiaoda.com/idcard?${params.toString()}`,
    {
      method: "GET",
      headers: {
