...
| Endpoint | `POST https://app-crzi248am2gx-api-ra5EZDjVKkXa-gateway.appmiaoda.com/image-generation/submit` |
| Content-Type | `application/json` |
| third_part_domain | `app-crzi248am2gx-api-ra5EZDjVKkXa-gateway.appmiaoda.com` |
...
| Endpoint（Web） | `POST https://app-crzi248am2gx-api-VaOwP2jDmAga-gateway.appmiaoda.com/image-generation/task` |
| Endpoint（MiniProgram） | `GET https://app-crzi248am2gx-api-VaOwP2jDmAga-gateway.appmiaoda.com/image-generation/task?taskId={taskId}` |
| Content-Type | `application/json` |
| third_part_domain | `app-crzi248am2gx-api-VaOwP2jDmAga-gateway.appmiaoda.com` |
| 计费 | 不启用 |
