...
| Endpoint | `POST http://app-crzi248am2gx-api-baBw3XMNVmv9-gateway.appmiaoda.com/v1/images/edits` |
...
async function editImage(params: EditImageParams): Promise<EditImageResult> {
  ...
  const response = await fetch(
    "http://app-crzi248am2gx-api-baBw3XMNVmv9-gateway.appmiaoda.com/v1/images/edits",
    {
      method: "POST",
      headers: {
