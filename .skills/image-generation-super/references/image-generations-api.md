...
| Endpoint | `POST http://app-crzi248am2gx-api-wLNdpny6ZpVa-gateway.appmiaoda.com/v1/images/generations` |
...
async function createImage(params: CreateImageParams): Promise<CreateImageResult> {
  const response = await fetch(
    "http://app-crzi248am2gx-api-wLNdpny6ZpVa-gateway.appmiaoda.com/v1/images/generations",
    {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
