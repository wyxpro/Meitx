...
| Endpoint | `POST https://app-crzi248am2gx-api-zYkZz8qoKDdL-gateway.appmiaoda.com/rest/2.0/image-classify/v1/image-understanding/get-result` |
| 生成期 URL（含 API ID） | `https://app-crzi248am2gx-api-zYkZz8qoKDdL-gateway.appmiaoda.com/rest/2.0/image-classify/v1/image-understanding/get-result` |
| Content-Type | `application/json` |
| Auth Header | `X-Gateway-Authorization: Bearer ${INTEGRATIONS_API_KEY}` |
| 认证模式 | `platform_managed` |
| third_part_domain | `app-crzi248am2gx-api-zYkZz8qoKDdL-gateway.appmiaoda.com` |
| 计费 | 不启用（查询接口免费） |
...
async function getImageUnderstandingResult(
  ...
  const response = await fetch(
    "https://app-crzi248am2gx-api-zYkZz8qoKDdL-gateway.appmiaoda.com/rest/2.0/image-classify/v1/image-understanding/get-result",
    {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
