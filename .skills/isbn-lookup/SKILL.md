...
- **Endpoint**：`POST https://app-crzi248am2gx-api-ra5EZDjVKbza-gateway.appmiaoda.com/isbn/query`
...
async function queryIsbnInfo(isbn: string): Promise<IsbnDetail[]> {
  const url = new URL("https://app-crzi248am2gx-api-ra5EZDjVKbza-gateway.appmiaoda.com/isbn/query");
