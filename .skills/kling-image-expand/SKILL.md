...
| 功能 | 方法 | 端点 |
|------|------|------|
| 创建扩图任务 | POST | `https://app-crzi248am2gx-api-Q9KWnzwVQMk9-gateway.appmiaoda.com/v1/images/editing/expand` |
| 查询单个任务 | GET  | `https://app-crzi248am2gx-api-rLobR6vwZJJ9-gateway.appmiaoda.com/v1/images/editing/expand/{task_id}` |
| 查询任务列表 | GET  | `https://app-crzi248am2gx-api-AalZkPVdZX8L-gateway.appmiaoda.com/v1/images/editing/expand` |
