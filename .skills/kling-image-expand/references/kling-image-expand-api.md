...
| third_part_domain | `app-crzi248am2gx-api-Q9KWnzwVQMk9-gateway.appmiaoda.com` |
...
| Endpoint | `POST https://app-crzi248am2gx-api-Q9KWnzwVQMk9-gateway.appmiaoda.com/v1/images/editing/expand` |
...
| Endpoint | `GET https://app-crzi248am2gx-api-rLobR6vwZJJ9-gateway.appmiaoda.com/v1/images/editing/expand/{task_id}` |
| Content-Type | `application/json` |
...
| Endpoint | `GET https://app-crzi248am2gx-api-AalZkPVdZX8L-gateway.appmiaoda.com/v1/images/editing/expand` |
| Content-Type | `application/json` |
...
async function createExpandTask(
  ...
  const response = await fetch(
    "https://app-crzi248am2gx-api-Q9KWnzwVQMk9-gateway.appmiaoda.com/v1/images/editing/expand",
    {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
...
async function queryExpandTask(taskId: string): Promise<TaskDetail> {
  const response = await fetch(
    `https://app-crzi248am2gx-api-rLobR6vwZJJ9-gateway.appmiaoda.com/v1/images/editing/expand/${encodeURIComponent(taskId)}`,
    {
      method: "GET",
      headers: {
        "Content-Type": "application/json",
...
async function listExpandTasks(pageNum = 1, pageSize = 30): Promise<TaskDetail[]> {
  const url = new URL(
    "https://app-crzi248am2gx-api-AalZkPVdZX8L-gateway.appmiaoda.com/v1/images/editing/expand",
  );
