...
| 步骤 | API | Endpoint |
|------|-----|----------|
| 1. 创建图像生成任务 | 创建图像生成任务 | POST `https://app-crzi248am2gx-api-DLEO4zbkvoea-gateway.appmiaoda.com/v1/images/omni-image` |
| 2. 查询图像生成任务 | 查询单个图像生成任务 | GET `https://app-crzi248am2gx-api-79jK6nw4zxDL-gateway.appmiaoda.com/v1/images/omni-image/{id}` |
| 3. 创建图像生成任务（图像编辑入口） | 创建图像生成任务（图像编辑） | POST `https://app-crzi248am2gx-api-eLMlPzV7qWJ9-gateway.appmiaoda.com/v1/images/omni-image` |
