...
| Third-party Domain | `app-crzi248am2gx-api-DLEO4zbkvoea-gateway.appmiaoda.com` |
...
| 方法 | POST |
| Endpoint | `https://app-crzi248am2gx-api-DLEO4zbkvoea-gateway.appmiaoda.com/v1/images/omni-image` |
...
| 方法 | GET |
| Endpoint | `https://app-crzi248am2gx-api-79jK6nw4zxDL-gateway.appmiaoda.com/v1/images/omni-image/{id}` |
...
async function submitOmniImageTask(
  ...
  const response = await fetch(
    "https://app-crzi248am2gx-api-DLEO4zbkvoea-gateway.appmiaoda.com/v1/images/omni-image",
    {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
...
async function queryOmniImageTask(taskId: string): Promise<QueryTaskResult> {
  const response = await fetch(
    `https://app-crzi248am2gx-api-79jK6nw4zxDL-gateway.appmiaoda.com/v1/images/omni-image/${taskId}`,
    {
      method: "GET",
      headers: {
        "Content-Type": "application/json",
...
| 方法 | POST |
| Endpoint | `https://app-crzi248am2gx-api-eLMlPzV7qWJ9-gateway.appmiaoda.com/v1/images/omni-image` |
...
async function submitOmniImageEditTask(
  ...
  const response = await fetch(
    "https://app-crzi248am2gx-api-eLMlPzV7qWJ9-gateway.appmiaoda.com/v1/images/omni-image",
    {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
