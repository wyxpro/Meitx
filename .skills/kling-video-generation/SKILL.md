...
**端点：**
- 创建任务：`POST https://app-crzi248am2gx-api-oLpZb03wbNBa-gateway.appmiaoda.com/v1/videos/omni-video`
- 查询任务：`GET https://app-crzi248am2gx-api-o9wN0pyVE2ea-gateway.appmiaoda.com/v1/videos/omni-video/{task_id}`
...
async function generateVideoAndWait(
  ...
  while (Date.now() < deadline) {
    ...
    const queryResp = await fetch(
      `https://app-crzi248am2gx-api-o9wN0pyVE2ea-gateway.appmiaoda.com/v1/videos/omni-video/${taskId}`,
      {
        method: "GET",
        headers: {
...
const createResp = await fetch(
  "https://app-crzi248am2gx-api-oLpZb03wbNBa-gateway.appmiaoda.com/v1/videos/omni-video",
  {
    method: "POST",
    headers: {
      "Content-Type": "application/json",
