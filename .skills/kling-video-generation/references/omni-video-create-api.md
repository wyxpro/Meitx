...
| Endpoint | `POST https://app-crzi248am2gx-api-oLpZb03wbNBa-gateway.appmiaoda.com/v1/videos/omni-video` |
| Auth 模式 | `platform_managed`（`traefik: true`） |
| Auth Header | `X-Gateway-Authorization: Bearer ${INTEGRATIONS_API_KEY}` |
| Content-Type | `application/json` |
| third_part_domain | `app-crzi248am2gx-api-oLpZb03wbNBa-gateway.appmiaoda.com` |
