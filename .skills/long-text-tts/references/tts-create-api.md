...
| Endpoint | `POST https://app-crzi248am2gx-api-nYWNozBb8X3L-gateway.appmiaoda.com/rpc/2.0/tts/v1/create` |
| 生成期 URL | `https://app-crzi248am2gx-api-nYWNozBb8X3L-gateway.appmiaoda.com/rpc/2.0/tts/v1/create` |
| Auth 模式 | `platform_managed`（traefik: true） |
| Auth Header | `X-Gateway-Authorization: Bearer ${INTEGRATIONS_API_KEY}` |
| Content-Type | `application/json` |
| Third-party domain | `app-crzi248am2gx-api-nYWNozBb8X3L-gateway.appmiaoda.com` |
...
async function createTTSTask(
  ...
  const response = await fetch(
    "https://app-crzi248am2gx-api-nYWNozBb8X3L-gateway.appmiaoda.com/rpc/2.0/tts/v1/create",
    {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
