...
| Endpoint | `POST https://app-crzi248am2gx-api-Q9KWZ2jy8W09-gateway.appmiaoda.com/rpc/2.0/tts/v1/query` |
| 生成期 URL | `https://app-crzi248am2gx-api-Q9KWZ2jy8W09-gateway.appmiaoda.com/rpc/2.0/tts/v1/query` |
| Auth 模式 | `platform_managed`（traefik: true） |
| Auth Header | `X-Gateway-Authorization: Bearer ${INTEGRATIONS_API_KEY}` |
| Content-Type | `application/json` |
| Third-party domain | `app-crzi248am2gx-api-Q9KWZ2jy8W09-gateway.appmiaoda.com` |
| 计费 | 不计费 |
...
async function queryTTSTask(taskId: string): Promise<{
  ...
  const response = await fetch(
    "https://app-crzi248am2gx-api-Q9KWZ2jy8W09-gateway.appmiaoda.com/rpc/2.0/tts/v1/query",
    {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
