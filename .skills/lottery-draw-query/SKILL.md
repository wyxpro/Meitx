...
| 接口 | 方法 | Endpoint |
|------|------|----------|
| 彩票开奖 | POST | `https://app-crzi248am2gx-api-baBw2m51JXz9-gateway.appmiaoda.com/caipiao/query` |
| 历史开奖信息 | POST | `https://app-crzi248am2gx-api-qYGW2z745vzY-gateway.appmiaoda.com/caipiao/history` |
| 查询是否中奖 | POST | `https://app-crzi248am2gx-api-2Y00V8pRRoxY-gateway.appmiaoda.com/caipiao/winning` |
| 彩票分类 | POST | `https://app-crzi248am2gx-api-BYdwQyx58E6L-gateway.appmiaoda.com/caipiao/class` |
