...
| Endpoint | `POST https://app-crzi248am2gx-api-BYdwQyx58E6L-gateway.appmiaoda.com/caipiao/class` |
| Auth | `platform_managed`，`X-Gateway-Authorization: Bearer ${INTEGRATIONS_API_KEY}` |
| Content-Type | `application/json` |
| Third-party Domain | `app-crzi248am2gx-api-BYdwQyx58E6L-gateway.appmiaoda.com` |
...
async function queryCaipiaoClass(): Promise<CaipiaoClassItem[]> {
  const response = await fetch(
    "https://app-crzi248am2gx-api-BYdwQyx58E6L-gateway.appmiaoda.com/caipiao/class",
    {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
