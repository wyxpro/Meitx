...
| Endpoint | `POST https://app-crzi248am2gx-api-qYGW2z745vzY-gateway.appmiaoda.com/caipiao/history` |
| Auth | `platform_managed`，`X-Gateway-Authorization: Bearer ${INTEGRATIONS_API_KEY}` |
| Content-Type | `application/json` |
| Third-party Domain | `app-crzi248am2gx-api-qYGW2z745vzY-gateway.appmiaoda.com` |
...
async function queryCaipiaoHistory(
  ...
  const url =
    `https://app-crzi248am2gx-api-qYGW2z745vzY-gateway.appmiaoda.com/caipiao/history?${params.toString()}`;
