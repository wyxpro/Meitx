...
| Endpoint | `POST https://app-crzi248am2gx-api-baBw2m51JXz9-gateway.appmiaoda.com/caipiao/query` |
| Auth | `platform_managed`，`X-Gateway-Authorization: Bearer ${INTEGRATIONS_API_KEY}` |
| Content-Type | `application/json` |
| Third-party Domain | `app-crzi248am2gx-api-baBw2m51JXz9-gateway.appmiaoda.com` |
...
async function queryCaipiaoResult(
  ...
  const url =
    `https://app-crzi248am2gx-api-baBw2m51JXz9-gateway.appmiaoda.com/caipiao/query?${params.toString()}`;
