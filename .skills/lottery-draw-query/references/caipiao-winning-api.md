...
| Endpoint | `POST https://app-crzi248am2gx-api-2Y00V8pRRoxY-gateway.appmiaoda.com/caipiao/winning` |
| Auth | `platform_managed`，`X-Gateway-Authorization: Bearer ${INTEGRATIONS_API_KEY}` |
| Content-Type | `application/json` |
| Third-party Domain | `app-crzi248am2gx-api-2Y00V8pRRoxY-gateway.appmiaoda.com` |
...
async function queryCaipiaoWinning(
  ...
  const url =
    `https://app-crzi248am2gx-api-2Y00V8pRRoxY-gateway.appmiaoda.com/caipiao/winning?${params.toString()}`;
