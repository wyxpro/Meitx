...
| Endpoint（单帧） | `POST https://app-crzi248am2gx-api-VaOw5VAJdQBa-gateway.appmiaoda.com/v1/video_generation` |
| Endpoint（首尾帧） | `POST https://app-crzi248am2gx-api-nYWNRQr5pV1L-gateway.appmiaoda.com/v1/video_generation` |
| Auth | `platform_managed`，`X-Gateway-Authorization: Bearer <INTEGRATIONS_API_KEY>` |
| Content-Type | `application/json` |
| third_part_domain | `app-crzi248am2gx-api-VaOw5VAJdQBa-gateway.appmiaoda.com` |
...
async function submitImageToVideo(
  ...
  const response = await fetch(
    "https://app-crzi248am2gx-api-VaOw5VAJdQBa-gateway.appmiaoda.com/v1/video_generation",
    {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
...
async function submitFirstLastFrameToVideo(
  ...
  const response = await fetch(
    "https://app-crzi248am2gx-api-nYWNRQr5pV1L-gateway.appmiaoda.com/v1/video_generation",
    {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
...
serve(async (req: Request): Promise<Response> => {
  ...
  const upstream = await fetch(
    `https://${apiId}@app-crzi248am2gx-api-VaOw5VAJdQBa-gateway.appmiaoda.com/v1/video_generation`,
    {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
