...
| Endpoint | `GET https://app-crzi248am2gx-api-GYX1bq2l5vWa-gateway.appmiaoda.com/v1/query/video_generation` |
| Auth | `platform_managed`（`X-Gateway-Authorization: Bearer ${INTEGRATIONS_API_KEY}`） |
| Content-Type | 无请求体 |
| third_part_domain | `app-crzi248am2gx-api-GYX1bq2l5vWa-gateway.appmiaoda.com` |
