...
| Endpoint | `POST https://app-crzi248am2gx-api-oLpZbv47qvea-gateway.appmiaoda.com/v1/video_generation` |
| Auth | `platform_managed`（`X-Gateway-Authorization: Bearer ${INTEGRATIONS_API_KEY}`） |
| Content-Type | `application/json` |
| third_part_domain | `app-crzi248am2gx-api-oLpZbv47qvea-gateway.appmiaoda.com` |
