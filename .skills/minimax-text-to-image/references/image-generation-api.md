...
| Endpoint | `POST https://app-crzi248am2gx-api-DLEO7vB8pQba-gateway.appmiaoda.com/v1/image_generation` |
| 认证模式 | `platform_managed` |
| Auth Header | `X-Gateway-Authorization: Bearer ${INTEGRATIONS_API_KEY}` |
| Content-Type | `application/json` |
| Third-party Domain | `app-crzi248am2gx-api-DLEO7vB8pQba-gateway.appmiaoda.com` |
...
async function generateImages(
  ...
  const response = await fetch(
    "https://app-crzi248am2gx-api-DLEO7vB8pQba-gateway.appmiaoda.com/v1/image_generation",
    {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
