...
| 第三方域名 | `app-crzi248am2gx-api-V9gDzg15D7BL-gateway.appmiaoda.com` |
...
| 方法 | POST |
| Endpoint | `https://app-crzi248am2gx-api-V9gDzg15D7BL-gateway.appmiaoda.com/v1/video_generation` |
...
async function submitTextToVideo(
  ...
  const response = await fetch(
    "https://app-crzi248am2gx-api-V9gDzg15D7BL-gateway.appmiaoda.com/v1/video_generation",
    {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
...
serve(async (req: Request): Promise<Response> => {
  ...
  // --- Call upstream ---
  const upstream = await fetch("https://app-crzi248am2gx-api-V9gDzg15D7BL-gateway.appmiaoda.com/v1/video_generation", {
    method: "POST",
    headers: {
      "Content-Type": "application/json",
      "X-Gateway-Authorization": `Bearer ${apiKey}`,
...
| 方法 | GET |
| Endpoint | `https://app-crzi248am2gx-api-zYkZz2eDWvPL-gateway.appmiaoda.com/v1/query/video_generation` |
| 计费 | 不计费 |
...
async function queryTextToVideo(taskId: string): Promise<{
  ...
  const url = new URL("https://app-crzi248am2gx-api-zYkZz2eDWvPL-gateway.appmiaoda.com/v1/query/video_generation");
...
| 方法 | GET |
| Endpoint | `https://app-crzi248am2gx-api-GYX1ld3ExkQa-gateway.appmiaoda.com/v1/files/retrieve` |
| 计费 | 不计费 |
...
async function retrieveVideoFile(fileId: string): Promise<{
  ...
  const url = new URL("https://app-crzi248am2gx-api-GYX1ld3ExkQa-gateway.appmiaoda.com/v1/files/retrieve");
