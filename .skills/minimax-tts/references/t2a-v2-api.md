...
| Endpoint | `POST https://app-crzi248am2gx-api-DLEO7Bj0lORa-gateway.appmiaoda.com/v1/t2a_v2` |
| 备用地址 | `https://api-DLEO7Bj0lORa@api-bj.minimaxi.com/v1/t2a_v2` |
| 认证方式 | platform_managed |
| Auth Header | `X-Gateway-Authorization: Bearer ${INTEGRATIONS_API_KEY}` |
| Content-Type | `application/json` |
| third_part_domain | `app-crzi248am2gx-api-DLEO7Bj0lORa-gateway.appmiaoda.com` |
...
async function callMinimaxTTS(
  ...
  const response = await fetch("https://app-crzi248am2gx-api-DLEO7Bj0lORa-gateway.appmiaoda.com/v1/t2a_v2", {
    method: "POST",
    headers: {
      "Content-Type": "application/json",
...
serve(async (req: Request): Promise<Response> => {
  ...
  // --- 调用上游 ---
  const upstream = await fetch("https://app-crzi248am2gx-api-DLEO7Bj0lORa-gateway.appmiaoda.com/v1/t2a_v2", {
    method: "POST",
    headers: {
      "Content-Type": "application/json",
      "X-Gateway-Authorization": `Bearer ${apiKey}`,
