...
| Endpoint | `POST https://app-crzi248am2gx-api-zYm4zKQoePjL-gateway.appmiaoda.com/rest/2.0/image-classify/v2/advanced_general` |
| 生成期 Endpoint（含 API ID 前缀） | `POST https://app-crzi248am2gx-api-zYm4zKQoePjL-gateway.appmiaoda.com/rest/2.0/image-classify/v2/advanced_general` |
| Auth 模式 | `platform_managed` |
| Auth Header | `X-Gateway-Authorization: Bearer ${INTEGRATIONS_API_KEY}` |
| Content-Type | `application/x-www-form-urlencoded` |
| third_part_domain | `app-crzi248am2gx-api-zYm4zKQoePjL-gateway.appmiaoda.com` |
| 流式响应 | 否 |
...
async function recognizeObjectsAndScenes(
  ...
  const response = await fetch(
    "https://app-crzi248am2gx-api-zYm4zKQoePjL-gateway.appmiaoda.com/rest/2.0/image-classify/v2/advanced_general",
    {
      method: "POST",
      headers: {
        "Content-Type": "application/x-www-form-urlencoded",
