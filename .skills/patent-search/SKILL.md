...
| 接口 | 方法 | Endpoint | 核心参数 |
|------|------|----------|----------|
| 企业专利列表查询 | POST | `https://app-crzi248am2gx-api-79jKP8yo70AL-gateway.appmiaoda.com/enterprise/patent/list` | keyword（公司名/注册号/统一信用代码）、pageNo、pageSize |
| 企业专利详情查询 | POST | `https://app-crzi248am2gx-api-eLMlJ2jB4oj9-gateway.appmiaoda.com/enterprise/patent/detail` | id（专利 ID） |
