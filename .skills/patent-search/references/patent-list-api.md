...
| Endpoint | `https://app-crzi248am2gx-api-79jKP8yo70AL-gateway.appmiaoda.com/enterprise/patent/list` |
| HTTP Method | POST |
| Content-Type | `application/json;charset=UTF-8` |
| Auth 模式 | platform_managed |
| Auth Header | `X-Gateway-Authorization: Bearer ${INTEGRATIONS_API_KEY}` |
| third_part_domain | `app-crzi248am2gx-api-79jKP8yo70AL-gateway.appmiaoda.com` |
...
async function fetchPatentList(
  ...
  const url = new URL(
    "https://app-crzi248am2gx-api-79jKP8yo70AL-gateway.appmiaoda.com/enterprise/patent/list",
  );
