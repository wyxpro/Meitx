...
- **Endpoint**：`POST https://app-crzi248am2gx-api-ELbWz8OmB58Y-gateway.appmiaoda.com/mobile/area`
...
async function queryMobileLocation(
  ...
  const url = new URL("https://app-crzi248am2gx-api-ELbWz8OmB58Y-gateway.appmiaoda.com/mobile/area");
...
serve(async (req: Request): Promise<Response> => {
  ...
  const upstreamUrl = new URL("https://app-crzi248am2gx-api-ELbWz8OmB58Y-gateway.appmiaoda.com/mobile/area");
