...
Agent 直接调用上游网关 API，使用 `api-{ID}@app-crzi248am2gx-api-pLVz4JBJbvKL-gateway.appmiaoda.com` 格式和 `X-Gateway-Authorization` 请求头。

**cURL**
```bash
curl -H "X-Gateway-Authorization: Bearer $INTEGRATIONS_API_KEY" \
  "https://app-crzi248am2gx-api-pLVz4JBJbvKL-gateway.appmiaoda.com/py-api/matches/2026-03-20_Bournemouth_2-2_Manchester-United/shots?span=full"
```
...
BASE = "https://app-crzi248am2gx-api-pLVz4JBJbvKL-gateway.appmiaoda.com/py-api"
...
const res = await fetch(
  `https://app-crzi248am2gx-api-pLVz4JBJbvKL-gateway.appmiaoda.com/py-api/matches/${mid}/rankings?span=full&metric=threat`,
