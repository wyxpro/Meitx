...
| Third-part Domain | `app-crzi248am2gx-api-ra5Err8G2Rla-gateway.appmiaoda.com` |
...
| 端点 | `POST https://app-crzi248am2gx-api-ra5Err8G2Rla-gateway.appmiaoda.com/precious-metal/domestic/price` |
...
| 端点 | `POST https://app-crzi248am2gx-api-rLobRR63mpd9-gateway.appmiaoda.com/precious-metal/domestic/kline` |
...
async function getDomesticKline(
  ...
  const response = await fetch(
    "https://app-crzi248am2gx-api-rLobRR63mpd9-gateway.appmiaoda.com/precious-metal/domestic/kline",
    {
      method: "POST",
      headers: {
        "Content-Type": "application/x-www-form-urlencoded",
...
| 端点 | `POST https://app-crzi248am2gx-api-DY8Mnnl0GGAa-gateway.appmiaoda.com/precious-metal/domestic/contract` |
...
async function getDomesticContract(symbol: string): Promise<unknown> {
  const response = await fetch(
    "https://app-crzi248am2gx-api-DY8Mnnl0GGAa-gateway.appmiaoda.com/precious-metal/domestic/contract",
    {
      method: "POST",
      headers: {
        "Content-Type": "application/x-www-form-urlencoded",
