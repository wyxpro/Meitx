...
| Third-part Domain | `app-crzi248am2gx-api-2Y00VV8Rkb2Y-gateway.appmiaoda.com` |
...
| 端点 | `POST https://app-crzi248am2gx-api-NLZ133Rnwr29-gateway.appmiaoda.com/precious-metal/inter/price` |
...
async function getInterPrice(symbol: string): Promise<unknown> {
  const response = await fetch(
    "https://app-crzi248am2gx-api-NLZ133Rnwr29-gateway.appmiaoda.com/precious-metal/inter/price",
    {
      method: "POST",
      headers: {
        "Content-Type": "application/x-www-form-urlencoded",
...
| 端点 | `POST https://app-crzi248am2gx-api-2Y00VV8Rkb2Y-gateway.appmiaoda.com/precious-metal/inter/kline` |
...
async function getInterKline(
  ...
  const response = await fetch(
    "https://app-crzi248am2gx-api-2Y00VV8Rkb2Y-gateway.appmiaoda.com/precious-metal/inter/kline",
    {
      method: "POST",
      headers: {
        "Content-Type": "application/x-www-form-urlencoded",
...
| 端点 | `POST https://app-crzi248am2gx-api-nYWNRRkexgKL-gateway.appmiaoda.com/precious-metal/inter/contract` |
...
async function getInterContract(symbol: string): Promise<unknown> {
  const response = await fetch(
    "https://app-crzi248am2gx-api-nYWNRRkexgKL-gateway.appmiaoda.com/precious-metal/inter/contract",
    {
      method: "POST",
      headers: {
        "Content-Type": "application/x-www-form-urlencoded",
