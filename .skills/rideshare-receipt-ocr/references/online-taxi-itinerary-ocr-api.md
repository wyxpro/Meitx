...
| Endpoint | `POST https://app-crzi248am2gx-api-zYkZz8qoKp1L-gateway.appmiaoda.com/rest/2.0/ocr/v1/online_taxi_itinerary` |
| Content-Type | `application/x-www-form-urlencoded` |
| 认证模式 | `platform_managed` |
| Auth Header | `X-Gateway-Authorization: Bearer ${INTEGRATIONS_API_KEY}` |
| third_part_domain | `app-crzi248am2gx-api-zYkZz8qoKp1L-gateway.appmiaoda.com` |
...
async function recognizeOnlineTaxiItinerary(
  ...
  const response = await fetch(
    "https://app-crzi248am2gx-api-zYkZz8qoKp1L-gateway.appmiaoda.com/rest/2.0/ocr/v1/online_taxi_itinerary",
    {
      method: "POST",
      headers: {
        "Content-Type": "application/x-www-form-urlencoded",
