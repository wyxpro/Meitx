...
| third_part_domain | `app-crzi248am2gx-api-GaDwZKpJxXOY-gateway.appmiaoda.com` |

| 接口 | API ID | Endpoint |
|------|--------|---------|
| 驾车路线规划 | `api-GaDwZKpJxXOY` | `GET https://app-crzi248am2gx-api-GaDwZKpJxXOY-gateway.appmiaoda.com/direction/v2/driving` |
| 骑行路线规划 | `api-W9z3MpAdKeNL` | `GET https://app-crzi248am2gx-api-W9z3MpAdKeNL-gateway.appmiaoda.com/direction/v2/riding` |
| 步行路线规划 | `api-wLNdomNRn42a` | `GET https://app-crzi248am2gx-api-wLNdomNRn42a-gateway.appmiaoda.com/direction/v2/walking` |
| 公交路线规划 | `api-m9xKXQkOKZXa` | `GET https://app-crzi248am2gx-api-m9xKXQkOKZXa-gateway.appmiaoda.com/direction/v2/transit` |
...
async function planRoute(
  ...
  const url = `https://${apiId}@app-crzi248am2gx-api-GaDwZKpJxXOY-gateway.appmiaoda.com/direction/v2/${mode}?${params.toString()}`;
...
serve(async (req: Request): Promise<Response> => {
  ...
  const upstreamUrl =
    `https://${apiId}@app-crzi248am2gx-api-GaDwZKpJxXOY-gateway.appmiaoda.com/direction/v2/${mode}?${params.toString()}`;
