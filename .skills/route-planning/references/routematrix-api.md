...
| third_part_domain | `app-crzi248am2gx-api-6LeBrqqMqKQY-gateway.appmiaoda.com` |

| 接口 | API ID | Endpoint |
|------|--------|---------|
| 驾车批量算路 | `api-6LeBrqqMqKQY` | `GET https://app-crzi248am2gx-api-6LeBrqqMqKQY-gateway.appmiaoda.com/routematrix/v2/driving` |
| 骑行批量算路 | `api-Aa2Pq88pDANL` | `GET https://app-crzi248am2gx-api-Aa2Pq88pDANL-gateway.appmiaoda.com/routematrix/v2/riding` |
| 步行批量算路 | `api-qYGW2zz1MklY` | `GET https://app-crzi248am2gx-api-qYGW2zz1MklY-gateway.appmiaoda.com/routematrix/v2/walking` |
...
async function batchCalcRoute(
  ...
  const url =
    `https://${apiId}@app-crzi248am2gx-api-6LeBrqqMqKQY-gateway.appmiaoda.com/routematrix/v2/${mode}?${params.toString()}`;
