...
| Endpoint | `https://app-crzi248am2gx-api-Aa2PZnjEw5NL-gateway.appmiaoda.com/server_api` |
| 网关 URL（含 API ID 前缀） | `https://app-crzi248am2gx-api-Aa2PZnjEw5NL-gateway.appmiaoda.com/server_api` |
| Method | POST |
| Content-Type | application/json |
| third_part_domain | `app-crzi248am2gx-api-Aa2PZnjEw5NL-gateway.appmiaoda.com` |
...
async function callShortSpeechRecognition(
  ...
  const response = await fetch("https://app-crzi248am2gx-api-Aa2PZnjEw5NL-gateway.appmiaoda.com/server_api", {
    method: "POST",
    headers: {
      "Content-Type": "application/json",
...
serve(async (req: Request): Promise<Response> => {
  ...
  // --- 调用上游 API ---
  const upstream = await fetch("https://app-crzi248am2gx-api-Aa2PZnjEw5NL-gateway.appmiaoda.com/server_api", {
    method: "POST",
    headers: {
      "Content-Type": "application/json",
      "X-Gateway-Authorization": `Bearer ${apiKey}`,
