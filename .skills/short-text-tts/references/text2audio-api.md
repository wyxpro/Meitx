...
| Endpoint | `POST https://app-crzi248am2gx-api-e94GZ5j0ljja-gateway.appmiaoda.com/text2audio` |
| 认证模式 | `platform_managed` |
| Auth Header | `X-Gateway-Authorization: Bearer ${INTEGRATIONS_API_KEY}` |
| Content-Type | `application/x-www-form-urlencoded` |
| Third-party Domain | `app-crzi248am2gx-api-e94GZ5j0ljja-gateway.appmiaoda.com` |
...
async function callTextToAudio(
  ...
  const response = await fetch("https://app-crzi248am2gx-api-e94GZ5j0ljja-gateway.appmiaoda.com/text2audio", {
    method: "POST",
    headers: {
      "Content-Type": "application/x-www-form-urlencoded",
...
serve(async (req: Request): Promise<Response> => {
  ...
  const upstream = await fetch("https://app-crzi248am2gx-api-e94GZ5j0ljja-gateway.appmiaoda.com/text2audio", {
    method: "POST",
    headers: {
      "Content-Type": "application/x-www-form-urlencoded",
      "X-Gateway-Authorization": `Bearer ${apiKey}`,
...
Deno.serve(async (req) => {
  ...
  return fetch("https://app-crzi248am2gx-api-e94GZ5j0ljja-gateway.appmiaoda.com/text2audio", {
    method: "POST",
    headers: {
      "Content-Type": "application/x-www-form-urlencoded",
