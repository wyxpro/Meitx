...
| 接口 | 端点 | 说明 |
|------|------|------|
| 发送短信验证码 | POST `https://app-crzi248am2gx-api-W9z3M74x6ZNL-gateway.appmiaoda.com/v1/code/send_message` | 向指定手机号发送验证码，返回 sessionId |
| 验证短信验证码 | POST `https://app-crzi248am2gx-api-Xa6JZxjyqK0a-gateway.appmiaoda.com/v1/code/verify_message_code` | 根据 sessionId + 手机号 + 验证码进行校验 |
