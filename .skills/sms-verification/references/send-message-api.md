...
| Endpoint | `POST https://app-crzi248am2gx-api-W9z3M74x6ZNL-gateway.appmiaoda.com/v1/code/send_message` |
| 认证模式 | `platform_managed` |
| Auth Header | `X-Gateway-Authorization: Bearer ${INTEGRATIONS_API_KEY}` |
| Content-Type | `application/json` |
| third_part_domain | `app-crzi248am2gx-api-W9z3M74x6ZNL-gateway.appmiaoda.com` |
...
async function sendSmsCode(
  ...
  const response = await fetch(
    "https://app-crzi248am2gx-api-W9z3M74x6ZNL-gateway.appmiaoda.com/v1/code/send_message",
    {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
