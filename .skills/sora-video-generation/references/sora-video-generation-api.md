...
|--------|-------|----------|--------|--------------|
| `api-Xa6Jew6JjAqa` | Create Video | `https://app-crzi248am2gx-api-Xa6Jew6JjAqa-gateway.appmiaoda.com/openai/v1/videos` | POST | multipart/form-data |
| `api-M9v0w87KjxoY` | Query Status | `https://app-crzi248am2gx-api-M9v0w87KjxoY-gateway.appmiaoda.com/query` | POST | application/json |
| `api-W9z3qro1AVZL` | Video from Reference | `https://app-crzi248am2gx-api-W9z3qro1AVZL-gateway.appmiaoda.com/openai/v1/videos` | POST | multipart/form-data |
| `api-M9v0wP10kQjY` | Remix Video | `https://app-crzi248am2gx-api-M9v0wP10kQjY-gateway.appmiaoda.com/openai/v1/videos/remix` | POST | application/json |
...
**third_part_domain:** `app-crzi248am2gx-api-Xa6Jew6JjAqa-gateway.appmiaoda.com`
...
**third_part_domain:** `app-crzi248am2gx-api-M9v0w87KjxoY-gateway.appmiaoda.com`
...
async function createVideo(params: {
  ...
  const res = await fetch(
    "https://app-crzi248am2gx-api-Xa6Jew6JjAqa-gateway.appmiaoda.com/openai/v1/videos",
    {
      method: "POST",
...
async function createVideoFromReference(params: {
  ...
  const res = await fetch(
    "https://app-crzi248am2gx-api-W9z3qro1AVZL-gateway.appmiaoda.com/openai/v1/videos",
    {
      method: "POST",
      headers: { "X-Gateway-Authorization": `Bearer ${apiKey}` },
      body: form,
...
async function remixVideo(params: {
  ...
  const res = await fetch(
    "https://app-crzi248am2gx-api-M9v0wP10kQjY-gateway.appmiaoda.com/openai/v1/videos/remix",
    {
      method: "POST",
      headers: {
...
async function queryVideoStatus(videoId: string): Promise<{
  ...
  const res = await fetch(
    "https://app-crzi248am2gx-api-M9v0w87KjxoY-gateway.appmiaoda.com/query",
    {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
