...
| Endpoint | `POST https://app-crzi248am2gx-api-Xa6JZxjyPlNa-gateway.appmiaoda.com/stock/hs/blocklist` |
| Auth | `platform_managed`（`X-Gateway-Authorization: Bearer ${INTEGRATIONS_API_KEY}`） |
| Content-Type | `application/x-www-form-urlencoded` |
| Third-party domain | `app-crzi248am2gx-api-Xa6JZxjyPlNa-gateway.appmiaoda.com` |
...
async function fetchBlockList(
  ...
  const response = await fetch(
    "https://app-crzi248am2gx-api-Xa6JZxjyPlNa-gateway.appmiaoda.com/stock/hs/blocklist",
    {
      method: "POST",
      headers: {
        "Content-Type": "application/x-www-form-urlencoded",
