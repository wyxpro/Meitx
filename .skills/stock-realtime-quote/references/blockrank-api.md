...
| Endpoint | `POST https://app-crzi248am2gx-api-zYkZz8qovO1L-gateway.appmiaoda.com/stock/hs/blockrank` |
| Auth | `platform_managed`（`X-Gateway-Authorization: Bearer ${INTEGRATIONS_API_KEY}`） |
| Content-Type | `application/x-www-form-urlencoded` |
| Third-party domain | `app-crzi248am2gx-api-zYkZz8qovO1L-gateway.appmiaoda.com` |
...
async function fetchBlockRank(
  ...
  const response = await fetch(
    "https://app-crzi248am2gx-api-zYkZz8qovO1L-gateway.appmiaoda.com/stock/hs/blockrank",
    {
      method: "POST",
      headers: {
        "Content-Type": "application/x-www-form-urlencoded",
