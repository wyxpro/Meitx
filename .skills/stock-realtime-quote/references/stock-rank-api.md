...
| Endpoint | `POST https://app-crzi248am2gx-api-wLNdo2j5e6ga-gateway.appmiaoda.com/stock/hs/rank` |
| Auth | `platform_managed`（`X-Gateway-Authorization: Bearer ${INTEGRATIONS_API_KEY}`） |
| Content-Type | `application/x-www-form-urlencoded` |
| Third-party domain | `app-crzi248am2gx-api-wLNdo2j5e6ga-gateway.appmiaoda.com` |
...
async function fetchStockRank(
  ...
  const response = await fetch(
    "https://app-crzi248am2gx-api-wLNdo2j5e6ga-gateway.appmiaoda.com/stock/hs/rank",
    {
      method: "POST",
      headers: {
        "Content-Type": "application/x-www-form-urlencoded",
