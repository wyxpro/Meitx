...
| Endpoint | `GET https://app-crzi248am2gx-api-nYWNozBb5qML-gateway.appmiaoda.com/beta/video/generations/kling/text2video` |
| 认证模式 | `platform_managed` |
| Auth Header | `X-Gateway-Authorization: Bearer ${INTEGRATIONS_API_KEY}` |
| Content-Type | `application/json` |
| 第三方域名 | `app-crzi248am2gx-api-nYWNozBb5qML-gateway.appmiaoda.com` |
| 计费 | 不启用（查询接口免费） |
...
async function queryTextToVideo(taskId: string): Promise<{
  ...
  const url = new URL(
    "https://app-crzi248am2gx-api-nYWNozBb5qML-gateway.appmiaoda.com/beta/video/generations/kling/text2video"
  );
