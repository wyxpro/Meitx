...
| Endpoint | `POST https://app-crzi248am2gx-api-o9wN672BkyMa-gateway.appmiaoda.com/beta/video/generations/kling/text2video` |
| 认证模式 | `platform_managed` |
| Auth Header | `X-Gateway-Authorization: Bearer ${INTEGRATIONS_API_KEY}` |
| Content-Type | `application/json` |
| 第三方域名 | `app-crzi248am2gx-api-o9wN672BkyMa-gateway.appmiaoda.com` |
...
async function submitTextToVideo(
  ...
  const response = await fetch(
    "https://app-crzi248am2gx-api-o9wN672BkyMa-gateway.appmiaoda.com/beta/video/generations/kling/text2video",
    {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
