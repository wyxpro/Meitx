...
- **Endpoint**: `POST https://app-crzi248am2gx-api-e94GZ5j0PWpa-gateway.appmiaoda.com/rpc/2.0/mt/texttrans/v1`
...
async function translateText(
  ...
  const response = await fetch(
    "https://app-crzi248am2gx-api-e94GZ5j0PWpa-gateway.appmiaoda.com/rpc/2.0/mt/texttrans/v1",
    {
      method: "POST",
      headers: {
        "Content-Type": "application/json;charset=utf-8",
