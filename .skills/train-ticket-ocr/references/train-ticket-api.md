...
| Endpoint | `POST https://app-crzi248am2gx-api-Xa6JZxjyqZna-gateway.appmiaoda.com/rest/2.0/ocr/v1/train_ticket` |
| Content-Type | `application/x-www-form-urlencoded` |
| Auth Header | `X-Gateway-Authorization: Bearer <INTEGRATIONS_API_KEY>` |
| 认证模式 | `platform_managed` |
| Third-party Domain | `app-crzi248am2gx-api-Xa6JZxjyqZna-gateway.appmiaoda.com` |
| 流式响应 | 否 |
...
async function recognizeTrainTicket(params: TrainTicketParams): Promise<TrainTicketResult> {
  ...
  const response = await fetch(
    "https://app-crzi248am2gx-api-Xa6JZxjyqZna-gateway.appmiaoda.com/rest/2.0/ocr/v1/train_ticket",
    {
      method: "POST",
      headers: {
        "Content-Type": "application/x-www-form-urlencoded",
