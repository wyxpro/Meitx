...
| 能力 | 接口 | 方法 | API ID |
|------|------|------|--------|
| 车次查询 | `POST https://app-crzi248am2gx-api-DLEO73l7Vjwa-gateway.appmiaoda.com/train/line` | POST | `api-DLEO73l7Vjwa` |
| 余票查询 | `POST https://app-crzi248am2gx-api-DLEO73lBPZ2a-gateway.appmiaoda.com/train/ticket` | POST | `api-DLEO73lBPZ2a` |
| 站站查询 | `POST https://app-crzi248am2gx-api-V9PworyO6gEa-gateway.appmiaoda.com/train/station2s` | POST | `api-V9PworyO6gEa` |
...
const response = await fetch("https://<api_id>@app-crzi248am2gx-api-DLEO73l7Vjwa-gateway.appmiaoda.com<path>?<params>", {
  method: "POST",
  headers: {
