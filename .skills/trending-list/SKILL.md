...
- **Endpoint**: `GET https://app-crzi248am2gx-api-qYGWoqjEmMnY-gateway.appmiaoda.com/v2/tools/trending_lists/medium`
...
async function queryTrendingList(type: number): Promise<TrendingItem[]> {
  const url = new URL(
    "https://app-crzi248am2gx-api-qYGWoqjEmMnY-gateway.appmiaoda.com/v2/tools/trending_lists/medium"
  );
