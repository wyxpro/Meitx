...
| 接口 | 方法 | Endpoint |
|------|------|----------|
| 城市限行查询 | POST | `https://app-crzi248am2gx-api-pLVzAxRQyMWL-gateway.appmiaoda.com/vehiclelimit/query` |
| 获取支持限行查询的城市列表 | POST | `https://app-crzi248am2gx-api-DYJwnJVBwb4a-gateway.appmiaoda.com/vehiclelimit/city` |
