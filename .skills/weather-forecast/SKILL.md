...
| 接口 | 方法 | Endpoint | 核心功能 |
|------|------|----------|----------|
| 天气预报API | GET | `https://app-crzi248am2gx-api-Aa2PZnjEVgyL-gateway.appmiaoda.com/lundear/weather1d` | 今日实时天气 + 当天预报 |
| 未来7日天气预报API | GET | `https://app-crzi248am2gx-api-rY7JZ6jqrV6L-gateway.appmiaoda.com/lundear/weather7d` | 未来7天逐日天气预报 |
| 未来8-15日天气预报API | GET | `https://app-crzi248am2gx-api-oYA6ZGjReVpa-gateway.appmiaoda.com/lundear/weather15d` | 未来第8天到第15天天气预报 |
...
async function getWeather1d(areaCn: string): Promise<unknown> {
  const url = new URL("https://app-crzi248am2gx-api-Aa2PZnjEVgyL-gateway.appmiaoda.com/lundear/weather1d");
