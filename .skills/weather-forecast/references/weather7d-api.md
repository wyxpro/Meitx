...
| Endpoint | `GET https://app-crzi248am2gx-api-rY7JZ6jqrV6L-gateway.appmiaoda.com/lundear/weather7d` |
| 认证模式 | `platform_managed` |
| Auth Header | `X-Gateway-Authorization: Bearer ${INTEGRATIONS_API_KEY}` |
| Content-Type | 无请求体（GET 请求，参数通过 Query String 传递） |
| Third-Part Domain | `app-crzi248am2gx-api-rY7JZ6jqrV6L-gateway.appmiaoda.com` |
...
async function getWeather7d(params: {
  ...
  const url = new URL("https://app-crzi248am2gx-api-rY7JZ6jqrV6L-gateway.appmiaoda.com/lundear/weather7d");
...
serve(async (req: Request): Promise<Response> => {
  ...
  // --- 调用上游接口 ---
  const upstreamUrl = new URL("https://app-crzi248am2gx-api-rY7JZ6jqrV6L-gateway.appmiaoda.com/lundear/weather7d");
