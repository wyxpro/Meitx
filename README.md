...
| **小琪 AI 助手** | 多模态 AI 问答助手 | 提供支持音频录制/播放、图片分析、文件上传及一键经营问答的运营顾问聊天界面 |
...
│   │   ├── CommunicationPage.tsx    # 沟通纪要CRUD、待办清单及“小琪” AI 对话助手
...
### 7. 小琪多模态 AI 对话助手 (Xiaoqi Assistant)
